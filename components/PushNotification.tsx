...
export const subscribeUserToPush = async (userId: string) => {
  ...
  try {
    ...
    if (!subscription) {
      console.log("No existing subscription, subscribing new...");
    ...
    console.log("📋 [Frontend] Subscription Endpoint:", subscription.endpoint);
    console.log("📋 [Frontend] Subscription Keys:", JSON.stringify(subscription.toJSON().keys));
